...
4.  ridiculous Adventure: 每一个encounter的对手/产出都有default/random/self defined；不同的结果检定不同
...
3.  如何在这里面使用多POV叙事？
4.  轮盘行动；可控的随机性？
5.  重点在于与游戏中人物（NPC）的互动，需要属性（政治/经济/文化/军事/etc）检定的事件都用统一的卡牌战斗模型
    -   NPC可以根据你的属性和熟悉程度模糊化，例如李白一开始可能只是青衫男子，如果没有进一步的解锁可能到游戏结束也不会明确指出为李白
    -   可能和NPC交互触发相关剧情的事件都需要属性检定
    -   建筑仍然有建筑相关事件，解锁前提，和NPC习惯出入的地点
6.
